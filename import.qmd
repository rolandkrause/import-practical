...
4. Run `renv::restore()` to install the packages required.

5. Add a code chunk and to load the libraries. You only need `readr`.
...
This is how all practicals and projects will be submitted. 
